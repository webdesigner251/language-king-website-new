...
const PTEFame = () => {
  ...
  const deleteFameEntry = async (id) => {
    if (!id) {
  ...
  const filteredEntries = fameEntries.filter(
    (entry) =>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg font-medium">Loading PTE Fame...</p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">PTE Fame</h1>
            <p className="text-gray-600">Manage PTE Hall of Fame entries</p>
          </div>
          <button
      ...
      {filteredEntries.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">
            {searchTerm ? "No Entries Found" : "No PTE Fame Entries Found"}
          </h3>
          <p className="text-gray-600 mb-6 max-w-md mx-auto">
            {searchTerm ? "Try adjusting your search terms." : "Add your first PTE Fame entry to get started!"}
          </p>
          {!searchTerm && (
            <button
              onClick={handleAddNew}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  <tr key={entry.id} className="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => deleteFameEntry(entry.id)}
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <p className="text-sm text-gray-600">
              Showing {filteredEntries.length} of {fameEntries.length} entries
            </p>
          </div>
        </div>
      )}
