        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">
              Manage your NAATI-CCL student records and achievements
            </p>
          </div>
          <button
            onClick={onAddNew}
            className="bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200 flex items-center gap-2 shadow-sm"
          >
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      {filteredStudents.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">
            {searchTerm ? "No Students Found" : "No NAATI-CCL Students Found"}
          </h3>
          <p className="text-gray-600 mb-6 max-w-md mx-auto">
            {searchTerm
              ? "Try adjusting your search terms."
              : "Add your first NAATI-CCL student to get started!"}
          </p>
          {!searchTerm && (
            <button
              onClick={onAddNew}
              className="bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200 inline-flex items-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="bg-green-50 hover:bg-green-100 text-green-600 p-2 rounded-lg transition-colors duration-200 group"
                          title="Edit Student"
                        >
                          <svg
...
export default NAATICCLStudents;
